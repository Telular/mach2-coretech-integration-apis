...
namespace RedisCacheLib
{
    public static class Retry
    {
        ...
        public static T WhileException<T>(int retries, int delayMs, Func<T> operation, Type exceptionType = null, bool allowDerivedExceptions = false)
        {
        ...
        public static void WhileException(int retries, int delayMs, Action operation, Type exceptionType = null, bool allowDerivedExceptions = false)
        {
            // Do all but one retries in the loop
            for (var retry = 1; retry < retries; retry++)
            {
