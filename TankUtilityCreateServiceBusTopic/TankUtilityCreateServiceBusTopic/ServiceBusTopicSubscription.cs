...
namespace TankUtilityCreateServiceBusTopic
{
    ...
    public class ServiceBusTopicSubscription
    {
       // private readonly TopicClient _topicClient;
        ...
        /// </summary>
        private static ServiceBusTopicSubscription _singletonSender;
        ...
        /// </summary>
        public static ServiceBusTopicSubscription Instance
        {
            get
            {
                if (_singletonSender == null)
                {
                    lock (_singletonLock)
                    {
                        if (_singletonSender == null)
                        {
                            _singletonSender = new ServiceBusTopicSubscription();
                        }
                    }
                }
